...
export function RegisterForm({ ...props }: React.ComponentProps<typeof Card>) {
  const formSchema = z.object({
    name: z.string().min(4, "minimum 4 words required"),
            ...
            <form.Field name="name" children={(field) => {
              ...
              return (
                <Field data-invalid={isInvalid}>
                  ...
                  <Input id={field.name} name={field.name} onChange={(e) => field.handleChange(e.target.value)} aria-invalid={isInvalid} placeholder="Your Name"autoComplete="off"/>
                  {isInvalid && (
